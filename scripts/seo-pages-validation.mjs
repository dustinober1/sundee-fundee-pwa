...
const supportRoutePath = path.join(root, "src/app/support/page.tsx");
assert.ok(fs.existsSync(supportRoutePath), "/support route should exist for App Store support URLs");
...
assert.match(support, /Pressure Wash Quote Maker/, "Support page should include Pressure Wash Quote Maker support content");
assert.match(support, /support@sundeefundee\.com/, "Support page should include a direct support email");
assert.match(support, /canonical:\s*"\/support"/, "Support page should define a canonical URL");
