...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      ...
      { href: "/readiness-score-strength-training", label: "Readiness" },
      { href: "/cycle-aware-training", label: "Cycle-Aware" },
      { href: "/strength-training-plan-for-women", label: "Strength Plans" },
      { href: "/tools/readiness-score-calculator", label: "Readiness Tool" },
      { href: "/tools/deload-week-planner", label: "Deload Tool" },
