  ...
  return (
    <form action={action} className="mt-4 grid gap-4 sm:grid-cols-2">
      ...
      <button
        type="submit"
        disabled={pending}
        className="sm:col-span-2 flex h-12 items-center justify-center rounded-full bg-navy font-medium text-cream transition-opacity hover:opacity-90 disabled:opacity-50"
      >
        {pending ? "Saving…" : "Add"}
      </button>
    </form>
